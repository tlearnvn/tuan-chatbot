...
<footer class="app-footer<?= !empty($opts['compact']) ? ' app-footer-compact' : '' ?>">
  <div class="footer-inner">
    ...
    <?php if (setting_bool('show_version')): ?>
      ...
      <?php /* Chỉ hiện số phiên bản. Tên mã xem ở trang lịch sử phiên bản. */ ?>
      <a class="footer-version" href="<?= e($base) ?>/changelog.php"
         title="Xem lịch sử phiên bản — <?= e(APP_CODENAME) ?>">
        <span class="version-dot"></span>v<?= e(APP_VERSION) ?>
      </a>
    <?php endif; ?>
    <?php foreach (footer_social_links() as $link): ?>
      <span class="footer-sep">•</span>
      <a class="footer-social footer-social-<?= e($link['key']) ?>"
         href="<?= e($link['url']) ?>" target="_blank" rel="noopener">
        <?= social_link_icon($link['key']) ?>
        <?= e($link['label']) ?>
      </a>
    <?php endforeach; ?>
  </div>
